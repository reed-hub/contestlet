...
-- This adds all missing columns and tables to bring production up to date
...
-- Production-specific: Update any existing contests to have proper defaults
UPDATE contests SET location_type = 'united_states' WHERE location_type IS NULL;

-- Verify the migration completed successfully
SELECT 
    'PRODUCTION MIGRATION COMPLETE' as status,
    COUNT(*) as contests_updated
FROM contests;
