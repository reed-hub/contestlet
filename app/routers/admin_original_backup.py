...
from app.schemas.role_system import UserWithRole, SponsorProfileResponse
...
async def get_all_sponsors(
    ...
    """Get all verified sponsor profiles for admin contest assignment"""
    sponsors = db.query(SponsorProfile).filter(
